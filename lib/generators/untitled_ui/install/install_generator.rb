  ...
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def create_tailwind_source_file
        ...
        relative_gem_path = gem_components_path.relative_path_from(app_path("app/assets/tailwind/untitled_ui"))
        source_content = <<~CSS
          /* Auto-generated by UntitledUi — tells Tailwind to scan gem components for classes */
          /* Regenerate with: rails generate untitled_ui:install */
          @source "#{relative_gem_path}/**/*.erb";
          @source "#{relative_gem_path}/**/*.rb";
        CSS
