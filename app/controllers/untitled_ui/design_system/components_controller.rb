  ...
  module DesignSystem
    class ComponentsController < UntitledUi::ApplicationController
      ...
      COMPONENTS = [
        ...
        { id: "pagination", name: "Pagination", category: "Application", description: "Pagination with 4 variant types, ellipsis algorithm, and prev/next navigation." },
        { id: "progress_steps", name: "Progress Steps", category: "Application", description: "Horizontal progress steps with centered icons, connector lines, and completed/current/upcoming states." }
      ].freeze
